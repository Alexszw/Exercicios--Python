...
if peso > 50 :
    excesso = peso - 50
    multa = excesso * 4
    print("Você pescou mais que o estabelecido pelo regulamento :")
    print(f"O excesso de peso foi de : {excesso} Kgs e a multa é de R$ {multa} reais")
else :
    print("Você não ultrapassou o limite de peso estabelecido .")
